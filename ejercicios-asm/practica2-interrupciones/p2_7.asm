;Escribir un programa que efectue la suma de dos numeros (de un digito)
;y muestre en pantalla el resultado. Recordar que el codigo de cada caracter
;ingresado no coincide con el numero que representa y que el resultado
;necesite ser expresado con dos digitos
ORG 1000H
...
SUB AL, 30H ; Le resto 30H, para quedarme con el valor del numero EJEMPLO INGRESO EL 5 -->35h, 35H - 30H = 5
ADD AL, NUM1 ; Le sumo el primer caracter leido EJEMPLO INGRESO EL 6 -->36H, 36H + 5H = 41H
...
JS NUM_OK ; Si se encendio en flag de signo quiere de cir que dio < 0 por lo tanto es menor a (3AH = 40)
SUB AL, 10 ; Si quedo un valor mayor a 39H   EJEMPLO 41H -10H = 31H
